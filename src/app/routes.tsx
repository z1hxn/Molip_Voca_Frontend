  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/voca/:id" element={<ProtectedRoute><VocaDetailPage /></ProtectedRoute>} />
        ...
        <Route path="/study/:id" element={<ProtectedRoute><StudySelectPage /></ProtectedRoute>} />
        <Route path="/study/:id/flashcard" element={<ProtectedRoute><FlashcardPage /></ProtectedRoute>} />
        <Route path="/study/:id/multiple_choice" element={<ProtectedRoute><MultipleChoicePage /></ProtectedRoute>} />
        <Route path="/study/:id/writing" element={<ProtectedRoute><WritingPage /></ProtectedRoute>} />
